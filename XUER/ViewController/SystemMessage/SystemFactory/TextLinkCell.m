...
- (void)setContentView:(XRMessageListInfo *)cellInfo {
    ...
    textView.frame = CGRectMake(CGRectGetMaxX(iconImg.frame)+5, CGRectGetMinY(iconImg.frame), kScreenWidth-90, contentSize.height+50);
    ...
    self.linkbtn.frame = CGRectMake(15, contentSize.height+20, linkContentSize.width>kScreenWidth-130?kScreenWidth-130:linkContentSize.width, 20);
