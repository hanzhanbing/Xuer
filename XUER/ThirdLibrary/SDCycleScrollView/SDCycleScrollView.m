...
- (void)loadImageAtIndex:(NSInteger)index
{
    ...
    @try {
        ...
        data = [NSData getDataCacheWithIdentifier:urlStr];
        // 如果有缓存，直接加载缓存
    }
...
//    UIImageView *iiii = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 10, 10)];

//    [iiii sd_setImageWithURL:url completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
//        NSLog(@"测试似乎");
//        if (!error) {
