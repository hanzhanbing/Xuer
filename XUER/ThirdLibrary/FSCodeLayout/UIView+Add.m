...
{
    [self setWidthToAutoresizeScreenWidthWithCount:1];
}

-(void)setWidthToAutoresizeScreenWidthWithCount:(NSInteger)count
{
    switch ([FSCodeLayout iphoneType])
    {
        case FSiPhoneType_4s:
        {
            self.width -= (kiPhone5sWidth - kiPhone4sWidth)/count;
        }
            break;
        ...
        case FSiPhoneType_6:
        {
            self.width += (kiPhone6Width - kiPhone5sWidth)/count;
        }
            break;
        case FSiPhoneType_6plus:
        {
            self.width += (kiPhone6plusWidth - kiPhone5sWidth)/count;
        }
            break;
...
-(void)setXToAddResizeScreenWidth
{
    switch ([FSCodeLayout iphoneType])
    {
        case FSiPhoneType_4s:
        ...
        case FSiPhoneType_6:
        {
            self.x += kiPhone6Width - kiPhone5sWidth;
        }
            break;
        case FSiPhoneType_6plus:
        {
            self.x += kiPhone6plusWidth - kiPhone5sWidth;
        }
            break;
...
-(void)setYToAutoresizeScreenHeight
{
    switch ([FSCodeLayout iphoneType])
    {
        case FSiPhoneType_4s:
        {
            self.y -= kiPhone5sHeight - kiPhone4sHeight;
        }
            break;
        case FSiPhoneType_5s:
        {
        ...
        case FSiPhoneType_6:
        {
            self.y += kiPhone6Height - kiPhone5sHeight;
        }
            break;
        case FSiPhoneType_6plus:
        {
            self.y += kiPhone6plusHeight - kiPhone5sHeight;
        }
            break;
...
+(void)setYToAutoresizeScreenRatioWithViewArray:(NSArray *)viewArray
{
    for (int i = 0; i < viewArray.count; i++)
    {
        ...
        switch ([FSCodeLayout iphoneType])
        {
            ...
            case FSiPhoneType_6:
            {
                view.y += (kiPhone6Height - kiPhone5sHeight)/(viewArray.count+1)*(i+1);
            }
                break;
            case FSiPhoneType_6plus:
            {
                view.y += (kiPhone6plusHeight - kiPhone5sHeight)/(viewArray.count+1)*(i+1);
            }
                break;
